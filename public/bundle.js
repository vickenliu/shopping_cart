...
/***/ function(module, exports, __webpack_require__) {
	...
	var _genre = __webpack_require__(168);

	var _genre2 = _interopRequireDefault(_genre);

	var _lists = __webpack_require__(170);
	...
	var Layout = function (_Component) {
	  ...
	  _createClass(Layout, [{
	    key: 'updateCart',
	    value: function updateCart(obj) {
	      var arr = this.state.item.concat([obj]);
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { id: 'body' },
	        _react2.default.createElement(_header2.default, { selectedItems: this.state.item }),
	        _react2.default.createElement(_genre2.default, null),
	        _react2.default.createElement(_lists2.default, { handleClick: this.updateCart.bind(this) })
	      );
	    }
	  }]);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: 'pull-right', id: 'carddisplay' },
	              this.props.selectedItems.length,
	              ' items in your items',
	              _react2.default.createElement(_cart2.default, { selectedItems: this.props.selectedItems })
	            )
	          )
	        )
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _genreItem = __webpack_require__(169);

	var _genreItem2 = _interopRequireDefault(_genreItem);
	...
	var Genre = function (_Component) {
	  ...
	  function Genre() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Genre).apply(this, arguments));
	  }

	  _createClass(Genre, [{
	    key: 'render',
	    value: function render() {
	      var items = [{ name: 'toys' }, { name: 'Electronics' }];
	      var lists = items.map(function (item, i) {
	        return _react2.default.createElement(_genreItem2.default, _extends({}, item, { key: i }));
	      });
	      return _react2.default.createElement(
	        'ul',
	        _defineProperty({ className: 'sideBar' }, 'className', 'col-md-2 col-md-offset-1'),
	        lists
	      );
	    }
	  }]);
	...
	var Lists = function (_Component) {
	  ...
	  _createClass(Lists, [{
	    ...
	    value: function render() {
	      ...
	      var items = [{ name: 'Hello', bio: 'something to tell' }, { name: 'Cuba', bio: 'something to hide' }];
	      var lists = items.map(function (item, i) {
	        return _react2.default.createElement(_listItem2.default, _extends({}, item, { key: i, addMe: _this2.props.handleClick }));
	      });
	      return _react2.default.createElement(
	        'div',
	        { className: 'sideBar col-md-5 col-md-offset-2' },
	        lists
	      );
	    }
	  }]);
	...
	var ListItem = function (_Component) {
	  ...
	  _createClass(ListItem, [{
	    ...
	    value: function addToCart(e) {
	      ...
	      this.props.addMe({ name: name, bio: bio });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'button',
	            { className: 'btn btn-primary pull-right', onClick: this.addToCart.bind(this) },
	            'Add to Cart'
	          )
	        )
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cart = function (_Component) {
	  ...
	  _createClass(Cart, [{
	    key: 'render',
	    value: function render() {
	      var items = this.props.selectedItems.map(function (item, i) {
	        return _react2.default.createElement(_item2.default, _extends({}, item, { key: i }));
	      });
	      return _react2.default.createElement(
	        'div',
	        { id: 'cart' },
